# [Face-Attendance](https://github.com/YandLim/FaceAttendance-Project)
...
## 📷The framework and libraries I work with:
1. OpenCV
   - Image and video capture and processing.
   - Drawing shapes and person's name around the detected face.
