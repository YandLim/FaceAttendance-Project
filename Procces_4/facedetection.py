...
path = 'D:/Coding/Python/Facedetection/Procces_4/Student_Face'
...
def markAttendance(name, wb):
    ...
    if name not in myDataList:
        ...
        wb.save(r'D:\Coding\Python\Facedetection\Procces_4\Attendance.xlsx')

attendance_wb = load_workbook(filename=r'D:\Coding\Python\Facedetection\Procces_4\Attendance.xlsx')
